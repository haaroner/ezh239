...
\includegraphics[width=6cm, height=5cm]{task4.png}\\
 ...
 \includegraphics[width=7cm, height=5cm]{example_1.png}
 \begin{tikzpicture}[remember picture,overlay]
...
\begin{frame}
 ...
 \includegraphics[width=14cm, height=6cm]{example2.png}
 \begin{tikzpicture}[remember picture,overlay]
...
\begin{frame}
 ...
 \includegraphics[width=12cm, height=6.5cm]{example4.png}
 \begin{tikzpicture}[remember picture,overlay]
 	\node[draw,rounded corners,fill=green!3,text width=8cm,align=left]
 	at (11.3,0.75)  
 	{\begin{itemize}
...
Следующий метод это очередь. Работает схожим образом, но по умолчанию хранит структуры в одной ячейке\\
  ...
  \begin{frame}
  	...
  	\end{frame}
  	\begin{frame}
  		\Huge \centering \textbf{\textcolor{orange}{С STM32 всё!!!}}\\[0.5cm]
  		\includegraphics[width=8cm, height=5cm]{endMe.png}
  	\end{frame}
\end{document}
